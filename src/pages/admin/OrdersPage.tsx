...
function OrderCard({ order }: { order: Order }) {
  return (
    <Link
      ...
      className="flex flex-col gap-2 rounded-3xl border border-forest-950/10 bg-white p-4 transition-colors hover:border-forest-700/30 hover:bg-forest-950/[0.02] sm:p-5"
    >
